 ...
 * @author marci
 */
public class walkaPaladynWilk extends javax.swing.JFrame {


    public walkaPaladynWilk() {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        //        try {
            ...
            //        }
            WalkaZBosikami.walcz(paladyn, paladynhp, wilk);
...
//  jButton1.setEnabled(WalkaZBosikami.walcz(mag, maghp, miniboss));
        ...
        boolean bec = WalkaZBosikami.sprawdz(paladyn, paladynhp, wilk,wilkhp);
            ...
            if(paladyn.hpbohater<=0||paladyn.hpbohater<=0&&wilk.hp<=0)
            {
                jButton1.setEnabled(false);
...
//            WyjscieWin.isEnabled(WalkaZBosikami.walcz(mag, maghp, miniboss));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(walkaPaladynWilk.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
