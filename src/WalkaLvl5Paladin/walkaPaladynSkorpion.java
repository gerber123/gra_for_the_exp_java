...
import static bosy.WalkaZBosikami.x;
import static bosy.WalkaZBosikami.y;
 ...
 * @author marci
 */
public class walkaPaladynSkorpion extends javax.swing.JFrame {



    public walkaPaladynSkorpion() {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        //        try {
            ...
            //        }
            WalkaZBosikami.walcz(paladyn, paladynhp, skorpion);
...
//  jButton1.setEnabled(WalkaZBosikami.walcz(mag, maghp, miniboss));
        ...
        boolean bec = WalkaZBosikami.sprawdz(paladyn, paladynhp, skorpion,skorpionhp);
            ...
            if(paladyn.hpbohater<=0||paladyn.hpbohater<=0&&skorpion.hp<=0)
            {
                jButton1.setEnabled(false);
...
//            WyjscieWin.isEnabled(WalkaZBosikami.walcz(mag, maghp, miniboss));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(walkaPaladynSkorpion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
