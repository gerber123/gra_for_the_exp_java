 ...
 * @author marci
 */
public class walkaArcherWilk extends javax.swing.JFrame {


    public walkaArcherWilk() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/WalkaLvl5Archer/wolf.gif"))); // NOI18N
        ...
        jLabel3.setText("HP wilka "+wilk.hp+"");

        jLabel4.setText("Atak wilka : "+wilk.atk+"");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        //        try {
            ...
            //        }
            WalkaZBosikami.walcz(archer, archerhp, wilk);
       
        jLabel1.setText("Hp Bohatera: "+archer.hpbohater+"");
        jLabel3.setText("Hp Obrońcy Bossa: "+wilk.hp+"");

//  jButton1.setEnabled(WalkaZBosikami.walcz(mag, maghp, miniboss));
           
        boolean bec = WalkaZBosikami.sprawdz(archer, archerhp, wilk,wilkhp);
            ...
            if(bec==true)
            {
               ...
               WyjscieLose.setEnabled(false);
                        ...
                        if(archer.hpbohater<=0||archer.hpbohater<=0&&wilk.hp<=0)
            {
                jButton1.setEnabled(false);
...
//            WyjscieWin.isEnabled(WalkaZBosikami.walcz(mag, maghp, miniboss));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(walkaArcherWilk.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
