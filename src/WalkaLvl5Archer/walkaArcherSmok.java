 ...
 * @author marci
 */
public class walkaArcherSmok extends javax.swing.JFrame {


    public walkaArcherSmok() {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        //        try {
            ...
            //        }
            WalkaZBosikami.walcz(archer, archerhp, smok);
...
//  jButton1.setEnabled(WalkaZBosikami.walcz(mag, maghp, miniboss));
        ...
        boolean bec = WalkaZBosikami.sprawdz(archer, archerhp, smok,smokhp);
            ...
            if(bec==true)
            {
               ...
               WyjscieLose.setEnabled(false);
                                   ...
                                   if(archer.hpbohater<=0||archer.hpbohater<=0&&smok.hp<=0)
            {
                jButton1.setEnabled(false);
...
//            WyjscieWin.isEnabled(WalkaZBosikami.walcz(mag, maghp, miniboss));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(walkaArcherSmok.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
