 ...
 * @author marci
 */
public class BosArcher extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/bosy/smok.png"))); // NOI18N
        ...
        WyjscieWin.setText("Wróć do miasta");
        ...
        jLabel3.setText("HP Dragonita "+boss.hp+"");

        jLabel4.setText("Atak Dragonita: "+boss.atk+"");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        //        try {
            ...
            //        }
            WalkaZBosikami.walcz(archer, archerhp, boss);
       
        jLabel1.setText("Hp Bohatera: "+archer.hpbohater+"");
        jLabel3.setText("Hp Obrońcy Bossa: "+boss.hp+"");

//  jButton1.setEnabled(WalkaZBosikami.walcz(mag, maghp, miniboss));
           
        boolean bec = WalkaZBosikami.sprawdz(archer, archerhp, boss, bosshp);
            ...
            if(bec==true)
            {
               ...
               WyjscieLose.setEnabled(false);
                        ...
                        if(archer.hpbohater<=0||archer.hpbohater<=0&&boss.hp<=0)
            {
                jButton1.setEnabled(false);
...
//            WyjscieWin.isEnabled(WalkaZBosikami.walcz(mag, maghp, miniboss));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BosArcher.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
