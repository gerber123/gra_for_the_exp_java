 ...
 * @author marci
 */
public class miniBosArcher1 extends javax.swing.JFrame {

    /**
     * Creates new form BosMag
     */
    public miniBosArcher1() {
        initComponents();
    ...
    private void initComponents() {
        ...
        WyjscieWin.setText("Przejdź do komnaty bosa");
        ...
        jLabel3.setText("HP drugiego mini Bossa: "+miniboss1.hp+"");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        //        try {
            ...
            //        }
            WalkaZBosikami.walcz(archer, archerhp, miniboss1);
       
        jLabel1.setText("Hp Bohatera: "+archer.hpbohater+"");
        jLabel3.setText("Hp Obrońcy Bossa: "+miniboss1.hp+"");

//  jButton1.setEnabled(WalkaZBosikami.walcz(mag, maghp, miniboss));
           
        boolean bec = WalkaZBosikami.sprawdz(archer, archerhp, miniboss1,minibosshp1);
            ...
            if(bec==true)
            {
               ...
               WyjscieLose.setEnabled(false);
                                    ...
                                    if(archer.hpbohater<=0||archer.hpbohater<=0&&miniboss1.hp<=0)
            {
                jButton1.setEnabled(false);
...
//            WyjscieWin.isEnabled(WalkaZBosikami.walcz(mag, maghp, miniboss));
    ...
    private void WyjscieWinActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_WyjscieWinActionPerformed
                int a = JOptionPane.showConfirmDialog(null, "Czy jesteś gotów spojrzeć DRAGONITOWI w oczy i się z nim zmierzyć?");
        if(a==0)        
        new BosArcher().setVisible(true);

miniboss1.hp=minibosshp1.hp;
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(miniBosArcher1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new miniBosArcher1().setVisible(true);
            }
        });
    }
