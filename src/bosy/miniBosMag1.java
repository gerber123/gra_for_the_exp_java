 ...
 * @author marci
 */
public class miniBosMag1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Postacie/obrazki do postaci/mag.png"))); // NOI18N
        ...
        WyjscieWin.setText("Przejdz do komnaty bossa");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        //        try {
            ...
            //        }
            WalkaZBosikami.walcz(mag, maghp, miniboss1);
       
        jLabel1.setText("Hp Bohatera: "+mag.hpbohater+"");
        jLabel3.setText("Hp Obrońcy Bossa: "+miniboss1.hp+"");

//  jButton1.setEnabled(WalkaZBosikami.walcz(mag, maghp, miniboss));
           
        boolean bec = WalkaZBosikami.sprawdz(mag, maghp, miniboss1,minibosshp1);
            ...
            if(bec==true)
            {
               ...
               WyjscieLose.setEnabled(false);
                                    ...
                                    if(mag.hpbohater<=0||mag.hpbohater<=0&&miniboss1.hp<=0)
            {
                jButton1.setEnabled(false);
...
miniboss1.hp=minibosshp1.hp;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(miniBosMag1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new miniBosMag1().setVisible(true);
            }
        });
    }
