 ...
 * @author marci
 */
public class BosMag extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        //        try {
            ...
            //        }
            WalkaZBosikami.walcz(mag, maghp, boss);
...
//  jButton1.setEnabled(WalkaZBosikami.walcz(mag, maghp, miniboss));
        ...
        boolean bec = WalkaZBosikami.sprawdz(mag, maghp, boss, bosshp);
            ...
            if(bec==true)
            {
               ...
               WyjscieLose.setEnabled(false);
                                    ...
                                    if(mag.hpbohater<=0||mag.hpbohater<=0&&boss.hp<=0)
            {
                jButton1.setEnabled(false);
...
boss.hp=bosshp.hp;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BosMag.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
