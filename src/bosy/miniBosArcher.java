 ...
 * @author marci
 */
public class miniBosArcher extends javax.swing.JFrame {

    /**
     * Creates new form BosMag
     */
    public miniBosArcher() {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        //        try {
            ...
            //        }
            WalkaZBosikami.walcz(archer, archerhp, miniboss);
...
//  jButton1.setEnabled(WalkaZBosikami.walcz(mag, maghp, miniboss));
        ...
        boolean bec = WalkaZBosikami.sprawdz(archer, archerhp, miniboss,minibosshp);
            ...
            if(bec==true)
            {
               ...
               WyjscieLose.setEnabled(false);
                                    ...
                                    if(archer.hpbohater<=0||archer.hpbohater<=0&&miniboss.hp<=0)
            {
                jButton1.setEnabled(false);
...
miniboss.hp=minibosshp.hp;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(miniBosArcher.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
