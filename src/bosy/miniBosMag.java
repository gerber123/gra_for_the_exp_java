 ...
 * @author marci
 */
public class miniBosMag extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        //        try {
            ...
            //        }
            WalkaZBosikami.walcz(mag, maghp, miniboss);
...
//  jButton1.setEnabled(WalkaZBosikami.walcz(mag, maghp, miniboss));
        ...
        boolean bec = WalkaZBosikami.sprawdz(mag, maghp, miniboss,minibosshp);
            ...
            if(bec==true)
            {
               ...
               WyjscieLose.setEnabled(false);
                                    ...
                                    if(mag.hpbohater<=0||mag.hpbohater<=0&&miniboss.hp<=0)
            {
                jButton1.setEnabled(false);
...
miniboss.hp=minibosshp.hp;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(miniBosMag.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
