 ...
 * @author marci
 */
public class BosPaladyn extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        //        try {
            ...
            //        }
            WalkaZBosikami.walcz(paladyn, paladynhp, boss);
...
//  jButton1.setEnabled(WalkaZBosikami.walcz(mag, maghp, miniboss));
        ...
        boolean bec = WalkaZBosikami.sprawdz(paladyn, paladynhp, boss, bosshp);
            ...
            if(bec==true)
            {
               ...
               WyjscieLose.setEnabled(false);
                                    ...
                                    if(paladyn.hpbohater<=0||paladyn.hpbohater<=0&&boss.hp<=0)
            {
                jButton1.setEnabled(false);
...
//            WyjscieWin.isEnabled(WalkaZBosikami.walcz(mag, maghp, miniboss));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BosPaladyn.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
