 ...
 * @author marci
 */
public class EkwipunekMag extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText(ekiw.sprawdzdrop(mag));

        jLabel2.setFont(new java.awt.Font("DialogInput", 1, 14)); // NOI18N
        jLabel2.setText(ekiw.sprawdzhajs(mag));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EkwipunekMag.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EkwipunekMag().setVisible(true);
