 ...
 * @author marci
 */
public class EkwipunekArcher extends javax.swing.JFrame {

    /**
     * Creates new form ekwipunek
     */
    public EkwipunekArcher() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText(ekiw.sprawdzdrop(archer));

        jLabel2.setFont(new java.awt.Font("DialogInput", 1, 14)); // NOI18N
        jLabel2.setText(ekiw.sprawdzhajs(archer));
...
this.dispose();    }//GEN-LAST:event_jToggleButton1ActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EkwipunekArcher.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
